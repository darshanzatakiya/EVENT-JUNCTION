      ...
      <>
        <div className="mt-1 flex flex-col">
          <div className="hidden sm:block">
            ...
            <video  autoPlay loop muted playsInline style={{ width: '1920px', height: '400px', objectFit: 'cover' }}>
  <source src="../src/assets/vid.mp4" type="video/mp4" />
          ...
          <div className="mx-10 my-5 grid gap-x-6 gap-y-8 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 sm:mx-5 ">
            ...
            {events.length > 0 &&
  events.map((event) => {
  const imagePath = event.image; // Assuming event.image contains the full path
